...
const SignupForm = ({ signup }: SignupProps) => {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden flex items-center flex-col justify-center"
      ...
      }} className="lg:w-[30%] md:w-[70%] sm:w-[100%] h-auto flex justify-center items-center rounded-3xl border-[1px] border-[#BDBDBD] px-14 py-8">
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <div className="my-2 flex flex-col w-full">
            <input type="text" autoComplete="off"
              className={mode === "dark" ? "border-[1px] px-4 text-white border-[#BDBDBD] rounded-[8px] py-2 my-2 placeholder:text-lg bg-inherit" : "border-[1px] border-[#BDBDBD] px-4 rounded-[8px] py-2 my-2 placeholder:text-lg "}
            ...
            <input type="Email" autoComplete="off"
              className={mode === "dark" ? "border-[1px] px-4 text-white border-[#BDBDBD] rounded-[8px] py-2 my-2 placeholder:text-lg  bg-inherit" : "border-[1px] border-[#BDBDBD] rounded-[8px] py-2 my-2 placeholder:text-lg px-4 "}
              placeholder="email"
              name="email"
              onChange={() => handleChange}
            ...
            <input type="password" autoComplete="off"
              className={mode === "dark" ? "border-[1px] px-4 border-[#BDBDBD] rounded-[8px] py-2 my-2 placeholder:text-lg  text-white bg-inherit" : "border-[1px] border-[#BDBDBD] rounded-[8px] py-2 my-2 placeholder:text-lg px-4 "}
          ...
          <div>
            <p className="text-[#828282]">already a member?
              <Link to="/login"><span className="text-[#2F80ED] px-1">login</span></Link>
            </p>
          </div>
        </div>
      </form>
      <p className="text-[#828282] mt-2">created by <a href="https://github.com/Mutesa-Cedric">mutesa Cedric</a></p>
    </div>
  )
}
